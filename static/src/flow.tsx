...
const FlowView = React.memo(({ transactions, categoryFilter, dateRange, setDateRange, activePreset, setActivePreset, onNavigateToView, onSetCategoryFilter, onSetFilter, onSetDateRange, onSetInboxDateRange }) => {
  ...
  const { pulling: flowPulling, refreshing: flowRefreshing, pullY: flowPullY, handleTouchStart: flowTouchStart, handleTouchMove: flowTouchMove, handleTouchEnd: flowTouchEnd } = window.usePullToRefresh(function() { setRetryKey(function(k) { return k + 1; }); }, { scrollRef: flowScrollRef });
