    ...
    <>
      <div style={{ padding: "20px", display: "flex", flexDirection: "column", gap: 14 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <label style={{ fontSize: 11, textTransform: "uppercase", letterSpacing: "0.08em", color: "var(--ink-4)", fontWeight: 500, marginBottom: 0, cursor: "pointer", display: "flex", alignItems: "center", gap: 8 }}>
      ...
      {item && (
        <div style={{ padding: "0 20px 20px", display: "flex", flexDirection: "column", gap: 8 }}>
          <div style={{ borderTop: "1px solid var(--line)", paddingTop: 16 }}>
            <span style={{ fontSize: 11, textTransform: "uppercase", letterSpacing: "0.08em", color: "var(--ink-4)", fontWeight: 500, marginBottom: 8, display: "block" }}>Add Contribution</span>
      ...
      <div style={{ padding: "14px 20px", borderTop: "1px solid var(--line)", display: "flex", gap: 8 }}>
        ...
        <Button onClick={save} disabled={saving} variant="primary">{saving ? "Saving\u2026" : item ? "Save" : "Add Goal"}</Button>
      </div>
    </>
  );
