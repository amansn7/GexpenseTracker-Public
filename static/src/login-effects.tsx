...
(function(){
  ...
  function animate(){
    ...
    if(physActive){
      ...
      if(physActive){
        ...
        tgl.style.transform="translate("+(physX-right)+"px,"+(physY-bottom)+"px)";
      }
    }
  ...
  tgl.onclick=function(){try{window.hapticLight?.()}catch(e){}var n=dark()?"paper":"midnight";html.setAttribute("data-theme",n);localStorage.setItem("mf_theme",n);playToggleSound();};
  var obs=new MutationObserver(updateTheme);
  obs.observe(html,{attributes:true,attributeFilter:["data-theme"]});
  updateTheme();
  animate();

  // === Entrance: bottom-left → bouncing ball → bottom-right ===
