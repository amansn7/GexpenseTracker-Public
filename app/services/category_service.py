...
class CategoryService:
    ...
    @staticmethod
    async def load_for_llm(session: AsyncSession | None, user_id: str | None) -> str | None:
    ...
    @staticmethod
    async def get_list(session: AsyncSession, user_id: str) -> list[dict]:
    ...
    @staticmethod
    async def get_active_list(session: AsyncSession, user_id: str) -> list[dict]:
